...
* **[DND Modu:](https://github.com/verimor/Bulutsantralim-API/blob/master/dnd.md)** Uygulamalarınız üzerinden santralinizdeki dahilinin DND modunu aça veya kapatabilisiniz.
* **[Ses Dosyaları Listesine Erişim:](https://github.com/verimor/Bulutsantralim-API/edit/master/announcements.md)** Uygulamalarınız üzerinden santralinizdeki ses dosyalarının listesine erişebilirsiniz.
